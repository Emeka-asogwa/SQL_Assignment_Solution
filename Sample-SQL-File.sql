...
--
use My_sql;
CREATE TABLE IF NOT EXISTS `Emeka_user_details` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=001 ;

--
-- Dumping data for table `user_details`
--

INSERT INTO `Emeka_user_details` (`user_id`, `username`, `first_name`, `last_name`, `gender`, `password`, `status`) VALUES
...
INSERT INTO Emeka_user_details  VALUES (USER_ID, 'Casogwa','Emeka','Asogwa', 'Male','840840',2);
SELECT *FROM Emeka_user_details;
